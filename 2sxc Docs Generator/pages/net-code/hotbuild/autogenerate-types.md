...
The plan is to generate a auto-generated file `/ThisApp/Data/BlogPostAutoGenerated.cs` which would look like this:
...
1. **AutoGenerated Class**
    ...
    1. For now it must inherit from `ThisApp.Data.Item16` - a class which is provided by 2sxc
