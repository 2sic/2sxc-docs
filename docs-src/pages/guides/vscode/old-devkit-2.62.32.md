---
uid: Guides.VsCode.OldDevKit2.62.32
---

# Visual Studio Code - Guide for old C# DevKit 2.62.32

> [!WARNING]
> These are old docs, and should not be used any more.
>
> In 2026-03 we finally have an awesome solution for the C# DevKit suddenly stopped working.
> Previously, we had to recommend downgrading the C# extension to version `2.63.32`, but now we have a much better solution which works with the latest version of the C# DevKit.
>
> We are just preserving them in case someone needs the old instructions.
>
> Please use the latest instructions in the main [VS Code guide](xref:Guides.VsCode.Index) instead of these old instructions.
