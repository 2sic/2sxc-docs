...
<img src="./assets/string-dropdown-configuration.png" width="100%">
...
<img src="./assets/string-dropdown-with-free-text-initial.png" width="100%">
...
<img src="./assets/string-dropdown-with-free-text-typing.png" width="100%">
