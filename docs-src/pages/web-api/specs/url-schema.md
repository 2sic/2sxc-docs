...
The **URL Schema** describes how paths access WebAPIs. When using [$2sxc JS](xref:JsCode.2sxcApi.Index) or [sxc-angular](xref:JsCode.Angular.Index), most of this is automatic. This information is most useful for custom integrations or external clients such as mobile apps.
