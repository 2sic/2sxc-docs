...
3. `Configuration` [DynamicEntity](xref:NetCode.DynamicCode.Entity), contains the [configuration content-item](xref:Feat.AppConfig)
...
11. `Resources` [DynamicEntity](xref:NetCode.DynamicCode.Entity), all the multi-language labels etc. (see below)
12. `Settings` [DynamicEntity](xref:NetCode.DynamicCode.Entity), all the app-settings (see below)
