...
Run this in SQL Server Management Studio to remove the tables `ToSIC_EAV_ContextInfo`, `ToSIC_EAV_AttributesInSets`, rename table `ToSIC_EAV_AssignmentObjectTypes`, etc:
