...
The **URL Schema** describes how the paths look to access WebAPIs. When using [$2sxc JS](xref:JsCode.2sxcApi.$2sxc.Index) or other helpers like [dnn-sxc-angular](xref:JsCode.Angular.Index) most if this is automatic. So this information is most useful if you are doing something very custom or accessing 2sxc APIs from externally (like mobile apps).
