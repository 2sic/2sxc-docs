---
uid: NetCode.ApiChoice.WebApiBase
---
...
> [!TIP]
> This is basically identical with the [C# base classes such as CodeTyped](xref:Custom.Hybrid.CodeTyped),
...
1. [`Custom.Hybrid.ApiTyped`](xref:Custom.Hybrid.ApiTyped) - new in v16

## Older Base Classes (Dynamic)

These are the older - **Dynamic** base classes.
They are **not recommended for new development**, but still supported for backwards compatibility.

1. [`Custom.Hybrid.Api14`](xref:Custom.Hybrid.Api14) - v14
1. [`Custom.Hybrid.Api12`](xref:Custom.Hybrid.Api12) - v12
1. [`Custom.Dnn.Api12`](xref:Custom.Dnn.Api12) - v12; same as Hybrid, but with `Dnn` property
