...
1. User Identity: in this case you can specifiy a user GUID _new in 9.30, requires the [feature to be enabled](xref:Basics.LnF.Features.Index)_
1. Group ID(s): if a user is in any of these Dnn groups, the rule applies _new in 9.30, requires the [feature to be enabled](xref:Basics.LnF.Features.Index)_
