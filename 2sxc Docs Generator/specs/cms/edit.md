...
1. **[Field Data Types](xref:Basics.Data.Fields.Index)** and **[Input Types](xref:Specs.Data.Inputs.All)** which determine what options a field has and how it's stored
