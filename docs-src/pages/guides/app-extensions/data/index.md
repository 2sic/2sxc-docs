...
The idea is that you explain in this central location, how to do everything, and then link this page from the other pages which explain each part in detail.
